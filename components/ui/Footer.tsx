        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-white/60 text-sm mb-6 max-w-xs">
              Andhra Pradesh Handicrafts Development Corporation Ltd. - Preserving heritage, empowering artisans.
            </p>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-[#c9a227] hover:text-white transition-all"
          ...
          {footerLinks.map((col) => (
            <div key={col.title}>
              <h4 className="text-[#c9a227] font-medium mb-4 text-sm tracking-wider">
                {col.title}
              </h4>
